...
**Zespół:** [WPISZ IMIONA I NAZWISKA]
**Klasa:** 3 Technikum
**Data:** [WPISZ DATĘ]
...
| :--- | :--- | :--- |
| [np. name] | [np. string] | [np. Przechowuje imię klienta] |
| | | |
...
- [ ] Konsola przeglądarki jest czysta (brak "red errors").
- [ ] Wszystkie commity są widoczne na kanale #github-feed.
